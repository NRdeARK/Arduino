...
void trackLine2exx(int sl, int sr, int line) {
  int count = 0;
  while (count < line) {
    ///////////////////////////
    trackLine1(sl, sr);
...
//  Motor('F', 150, 'B', 150, 50);
  Motor('F', 130, 'F', 130, 70);
  trackLine2ex(130, 150, 4);
  Motor('F', 130, 'F', 130, 40);
  turnLeft_cut(150,150);
  
  
//  trackLine2ex(130, 130, 1);
//  Motor('F', 130, 'F', 130, 50);
//  turnLeft_cut(150,150);
  
  Motor('F', 130, 'F', 130, 140);
//  trackLine2ex(130, 130, 1);
 Motor('F', 130, 'F', 130, 30);
//  turnRight_cut(150, 150);
//  turnRight_cut(150, 150);
  trackLine2ex( 130, 130, 1);
  turnRight_cut(150,150);
  ...
  trackLine2exx(130, 130, 1);
  turnRight_cut(150,150);
  trackLine2exx(130, 130, 2);
